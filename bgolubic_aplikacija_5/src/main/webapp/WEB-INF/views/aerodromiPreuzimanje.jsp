	...
	<table border=1>
		...
		<c:forEach var="aerodrom" items="${aerodromi}">
			<tr>
				...
				<td><c:out value="${aerodrom.status}" /></td>
				<td><a
					href="${pageContext.servletContext.contextPath}/mvc/aerodromi/pauza?icao=${aerodrom.icao}">Pauziraj</a></td>
					<td><a
					href="${pageContext.servletContext.contextPath}/mvc/aerodromi/nastavi?icao=${aerodrom.icao}">Nastavi</a></td>
			</tr>
		</c:forEach>
